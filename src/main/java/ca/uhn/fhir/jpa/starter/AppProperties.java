...
public class AppProperties {
	...
	private Boolean custom_cr_id_enabled = false;
	...
	public Boolean getCustom_cr_id_enabled() {
		return custom_cr_id_enabled;
	}

	public void setCustom_cr_id_enabled(Boolean custom_cr_id_enabled) {
		this.custom_cr_id_enabled = custom_cr_id_enabled;
	}
